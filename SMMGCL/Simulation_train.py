...
def loaddata(dataset):
    ...
    return adata_omics1, adata_omics2, feature_list, spatial_list, adj_wave_list, adj_hat_list, labels_list
...
if __name__ == '__main__':
    ...
    # datasets = ['Dataset13_Simulation1', 'Dataset14_Simulation2', 'Dataset15_Simulation3', 'Dataset16_Simulation4',
    #             'Dataset17_Simulation5']
    for i in range(len(datasets)):
        ...
        adata1, adata2, feature_list, spatial_list, adj_wave_list, adj_hat_list, labels_list = loaddata(dataset)
        ...
        #                 title='SMMGCL', s=100, show=False)
        # plt.tight_layout(w_pad=0.3)
        # plt.show()
        # plt.savefig(args.savepath + 'SMMGCL_mclust.jpg', bbox_inches='tight', dpi=600)
